...
fn wire_smtc_button_press_event_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, (), _>(
        ...
        move || {
            let api_internal = internal.wire2api();
            move |task_callback| {
                smtc_button_press_event(api_internal, task_callback.stream_sink::<_, String>())
            }
        },
    )
}
fn wire_smtc_position_change_request_event_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, (), _>(
        ...
        move || {
            let api_internal = internal.wire2api();
            move |task_callback| {
                smtc_position_change_request_event(
                    api_internal,
                    task_callback.stream_sink::<_, i64>(),
                )
            }
        },
    )
...
fn wire_smtc_shuffle_request_event_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, (), _>(
        ...
        move || {
            let api_internal = internal.wire2api();
            move |task_callback| {
                smtc_shuffle_request_event(api_internal, task_callback.stream_sink::<_, bool>())
            }
        },
    )
}
fn wire_smtc_repeat_mode_request_event_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, (), _>(
        ...
        move || {
            let api_internal = internal.wire2api();
            move |task_callback| {
                smtc_repeat_mode_request_event(
                    api_internal,
